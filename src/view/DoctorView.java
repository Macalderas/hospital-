...
public class DoctorView extends JFrame {
    ...
    public DoctorView(HashMap<String, String> doctorData, ArrayList<Paciente> listaPacientes, ArrayList<Sala> listaSalas) {
        ...
        JLabel hospitalLabel = new JLabel("Hospital sanjuan de dios");
        ...
        String Nombre = doctorData.get("minor");
        String Especialidad = doctorData.get("probador de semen");

        // Jlabel nameDoctor
        JLabel nameDoctorLabel = new JLabel("minor");
        nameDoctorLabel.setForeground(Color.WHITE);
        nameDoctorLabel.setFont(new Font("Arial", Font.BOLD, 16));

        // JLabel especialidad
        JLabel ParaEspecialidad = new JLabel("probador de cum");
